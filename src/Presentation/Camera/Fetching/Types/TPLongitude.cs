namespace Presentation.Camera.Fetching.Types
{
    ...
    public class TPLongitude : InputObjectGraphType<PLongitude>
    {
        public TPLongitude()
        {
            ...
            Field(longitude => longitude.LesserEqualThan, true)
                .Description("Cameras will have the longitude lesser or equal than this value.");

            Field(longitude => longitude.GreaterEqualThan, true)
                .Description("Cameras will have the longitude greater or equal than this value.");
        }
    }
}
